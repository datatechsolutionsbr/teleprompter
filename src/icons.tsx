...
export function MicrophoneSlashIcon(props: IconProps) {
  return (
    <svg {...baseProps} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M3 3l18 18M9 9v3.75a3 3 0 0 0 5.13 2.12M15 12.75V4.5a3 3 0 0 0-5.685-1.357" />
    </svg>
  )
}
